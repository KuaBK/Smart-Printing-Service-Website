...
public interface FileConfigRepository extends JpaRepository<FileConfig, Long> {
    @Query(value = "select fc.id, fc.paper_size, fc.paper_range, fc.sides, fc.number_of_copies, fc.layout, fc.color, fc.scale, fc.pages_print, fc.page_of_sheet, fc.margin, fc.qr_code, fc.document_id from file_config fc " +
