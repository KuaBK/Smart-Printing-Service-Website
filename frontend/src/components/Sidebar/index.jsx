  ...
  return (
    ...
    {props.value == 'user' &&
      <ul className='p-[10px] h-1/2 overflow-y-auto overflow-hidden'>
        <li className={selecInput == "HomePageUser" ? `${classes.itemSliderbar} ${classes.activate}` : classes.itemSliderbar} cur-value="HomePageUser" onClick={(e) => {setSelecInput(e.currentTarget.getAttribute('cur-value'))}}><a className='flex flex-row'><img src={category} className='pr-[10px]'/>Trang chính</a></li>
    ...
    {props.value == 'spso' && 
      <ul className='p-[10px] h-1/2 overflow-y-auto overflow-hidden'>
        <li className={selecInput == "HomePageSPSO" ? `${classes.itemSliderbar} ${classes.activate}` : classes.itemSliderbar} cur-value="HomePageSPSO" onClick={(e) => setSelecInput(e.currentTarget.getAttribute('cur-value'))}><a className='flex flex-row'><img src={category} className='pr-[10px]'/>Trang chính</a></li>
