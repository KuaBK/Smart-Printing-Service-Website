...
import hcmut.spss.be.entity.InvalidatedToken;
import hcmut.spss.be.entity.user.User;
import hcmut.spss.be.exception.AppException;
import hcmut.spss.be.exception.ErrorCode;
import hcmut.spss.be.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    private TokenInfo generateToken(User user) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .claim("accountId", user.getUserId())
